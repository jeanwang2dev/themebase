	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'themebase' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'themebase' ); ?></th>
			</tr>
		</thead>
		<tbody>
